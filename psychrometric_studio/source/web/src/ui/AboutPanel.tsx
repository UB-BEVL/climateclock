  ...
  return (
    <section className="about-panel">
      <p className="edu-text">
        ...
        Calculations run in your browser. This Climate Analysis Pro integration keeps the design for this browser session and sends solved results to the app for PDF reports.
      </p>
