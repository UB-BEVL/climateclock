...
import { isEmbedded } from '../climateclock/bridge.js';
...
export function ExportPanel({
  ...
  return (
    <section className="export-panel">
      ...
      {isEmbedded() && <p className="comfort-note">Use Download psychrometric PDF beneath the chart for BEVL and UB reports. The main Report tab includes these results in the full climate report.</p>}
      {pdfAvailable && !isEmbedded() && (
        <>
          <h3>Report</h3>
          <div className="export-actions">
            <button
